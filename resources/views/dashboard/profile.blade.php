            ...
            <div
                ...
                <div class="pb-6 ms-6 mb-6 me-6 -mt-[100px]">
                    <div class="text-center border-b border-neutral-200 dark:border-neutral-600">
                        <img src="admin_assets/images/user-grid/user-grid-img14.png" alt=""
                    ...
                    <div class="mt-6">
                        ...
                        <ul>
                            ...
                            <li class="flex items-center gap-1">
                                ...
                                <span class="w-[70%] text-secondary-light font-medium">: Lorem Ipsum is simply dummy text of the
                ...
                <div class="card-body p-6">
                    ...
                    <ul class="tab-style-gradient flex flex-wrap text-sm font-medium text-center mb-5" id="default-tab"
                        ...
                        <li class="" role="presentation">
                            <button
                                class="py-2.5 px-4 border-t-2 font-semibold text-base inline-flex items-center gap-3 text-neutral-600 hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                                id="notification-password-tab" data-tabs-target="#notification-password" type="button" role="tab"
                                aria-controls="notification-password" aria-selected="false">
                    ...
                    <div id="default-tab-content">
                            ...
                            <form action="#">
                                <div class="grid grid-cols-1 sm:grid-cols-12 gap-x-6">
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        <div class="mb-5">
                                            <label for="Language"
                                                class="inline-block font-semibold text-neutral-600 dark:text-neutral-200 text-sm mb-2">Language
                                                <span class="text-danger-600">*</span> </label>
                                    ...
                                    <div class="col-span-12">
                                        <div class="mb-5">
                                            ...
                                            <textarea name="#0" class="form-control rounded-lg" id="desc"
                        ...
                        <div class="hidden" id="notification-password" role="tabpanel"
                            ...
                            <div class="form-switch switch-primary py-3 px-4 border rounded-lg relative mb-4">
                                ...
                                <div class="flex items-center gap-3 justify-between">
                                    <span class="form-check-label line-height-1 font-medium text-secondary-light">Weekly News
                                        Letters</span>
                            ...
                            <div class="form-switch switch-primary py-3 px-4 border rounded-lg relative mb-4">
                                ...
                                <div class="flex items-center gap-3 justify-between">
                                    <span class="form-check-label line-height-1 font-medium text-secondary-light">Meetups Near
                                        you</span>
